...
urlpatterns = [
    ...
    # Calendar URLs for viewing and interacting with other users
    ...
    path('calendar/<str:username>/<int:year>/<int:month>/<int:day>/add/', views.add_event_view, name='add_event_user'),
